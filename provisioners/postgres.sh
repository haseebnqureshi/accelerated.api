...
echo "[accelerated.api/provision_postgres.sh] -- Configuring postgres"
...
echo "[accelerated.api/provision_postgres.sh] -- Restarting postgres service"

su postgres service postgresql restart

echo "[accelerated.api/provision_postgres.sh] -- Creating & importing database $DB_NAME"
