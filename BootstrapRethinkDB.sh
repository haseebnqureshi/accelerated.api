...
echo "[Accelerated/API/BootstrapRethinkDB.sh] Installing rethinkdb ..."

echo "[Accelerated/API/BootstrapRethinkDB.sh] -- Installing ubuntu rethinkdb drivers"
...
echo "[Accelerated/API/BootstrapRethinkDB.sh] -- Configuring rethinkdb"
...
echo "[Accelerated/API/BootstrapRethinkDB.sh] -- Restarting rethinkdb service"

/etc/init.d/rethinkdb restart

echo "[Accelerated/API/BootstrapRethinkDB.sh] -- Installing node rethinkdb drivers"

npm install rethinkdb --save --loglevel=error > /dev/null

echo "[Accelerated/API/BootstrapRethinkDB.sh] Finished installing rethinkdb!"
