...
echo "[ACCELERATED/BootstrapRethinkDB.sh] Installing rethinkdb ..."

echo "[ACCELERATED/BootstrapRethinkDB.sh] -- Installing ubuntu rethinkdb drivers"
...
echo "[ACCELERATED/BootstrapRethinkDB.sh] -- Configuring rethinkdb"
...
echo "[ACCELERATED/BootstrapRethinkDB.sh] -- Restarting rethinkdb service"

/etc/init.d/rethinkdb restart

echo "[ACCELERATED/BootstrapRethinkDB.sh] -- Installing node rethinkdb drivers"

npm install rethinkdb --save --loglevel=error > /dev/null

echo "[ACCELERATED/BootstrapRethinkDB.sh] Finished installing rethinkdb!"
